...
export const metadata = {
  title: "Terms and Conditions | FMCG Influencers",
  description:
    "Terms and Conditions for FMCG Influencers. Read our terms of service before using our platform.",
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8 md:mb-12">
              ...
              <ul className="list-disc pl-6 space-y-2 text-base md:text-lg text-gray-700 mb-6">
                ...
                <li>
                  ...
                  agreement between You and the Company regarding the use of
                  the Service. This Terms and Conditions agreement has been
                  created with the help of the Free Terms and Conditions
                  Generator.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to FMCGInfluencers.com,
                  accessible from https://www.fmcginfluencers.com/
                </li>
                <li>
            ...
            <section className="mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-4">
                ...
                or that has been designated by the United States government as
                a "terrorist supporting" country, and (ii) You are not listed
            ...
            <section className="mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
                ...
                require performance of an obligation under these Terms shall
            ...
            <section className="mb-8 md:mb-12">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                By email:{" "}
                <a
                  href="mailto:fmcginfluencers@gmail.com"
                  className="text-primary hover:underline"
                >
                  fmcginfluencers@gmail.com
                </a>
              </p>
            </section>
          </div>
