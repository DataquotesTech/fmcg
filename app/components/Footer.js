        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-sm">
              India’s trusted platform for FMCG talent, brands, and
              business solutions.
            </p>
          </div>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="w-12 h-12 flex items-center justify-center text-gray-600 hover:text-primary hover:bg-gray-100 rounded-xl transition-all"
