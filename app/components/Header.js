...
export default function Header() {
  ...
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/fmcginfluencers?igsh=MW1rZXUzOWY2YzN5bw==",
      icon: (
        <svg
          className="w-7 h-7"
          fill="currentColor"
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/share/1FBwFFrqHA/",
      icon: (
        <svg
          className="w-7 h-7"
          fill="currentColor"
    ...
    {
      name: "Twitter",
      href: "https://x.com/FmcgInfluencers",
      icon: (
        <svg
          className="w-7 h-7"
          fill="currentColor"
          ...
          aria-hidden="true"
        >
          <path d="M2 3h3.5l5 7.5L15 3h4.5l-6.5 9.5L20 21h-3.5l-5-7.5L9 21H4.5l6.5-9.5L2 3z" />
        </svg>
      ),
    },
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/fmcginfluencers/",
      icon: (
        <svg
          className="w-7 h-7"
          fill="currentColor"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@FMCGInfluencers",
      icon: (
        <svg
          className="w-7 h-7"
          fill="currentColor"
  ...
  return (
    <>
      ...
      <header className="w-full sticky top-0 z-50  flex items-center justify-center  bg-white">
                  ...
                  <div className="flex justify-center flex-wrap gap-4">
                    {socialLinks.map((link) => (
                      <a
                        ...
                        className="w-14 h-14 flex items-center justify-center text-gray-600 hover:text-primary hover:bg-gray-100 rounded-full transition-all"
